...
public class MyGdxGame implements ApplicationListener {
	...
	{		
		...
		for(int i=0;i<5;i++)
		{
			Pelotita p=new Pelotita((int )(Math.random()*1000%w),(int)(Math.random()*1000%h),new Texture("data/pelotita2.png"));
...
//			Pelotita p=new Pelotita();
	...
	public void render() {	
		...
		imagen.avanzar();
		if(frame%100==0)
		//s.addActor(new Pelotita((int )(Math.random()*1000%w),(int)(Math.random()*1000%h),new Texture("data/pelotita.png")));
